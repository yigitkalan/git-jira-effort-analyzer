    ...
    <div className="p-6 flex flex-col gap-6">
      ...
      <div className="glass-card p-4 rounded-xl flex items-center gap-4 flex-wrap">
        <div className="flex-1 min-w-300">
          ...
          <div
            className="flex items-center gap-2 bg-secondary/50 p-1.5 rounded-lg border border-color hover:border-accent/50 transition-colors"
          ...
          >
            ...
            <button
              onClick={onBrowse}
              className="text-xs px-3 py-1.5 bg-tertiary hover:bg-white/10 rounded-md"
            >
              Browse
            </button>
          </div>
        ...
        <div className="min-w-200">
          ...
          <div
            className="flex items-center gap-2 p-1.5 rounded-lg border border-color"
            style={{ background: 'var(--bg-tertiary)' }}
          >
            <div className="p-2 bg-blue-500/10 rounded-md text-accent">
              <Calendar size={18} />
